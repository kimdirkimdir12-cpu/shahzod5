...
const TOKEN = '8394291242:AAGnHZTODIC6ibfddM0faiqU1ZK8MxI1IR4';
...
app.get('/bm', (req, res) => {
  ...
  res.send(`
    (async()=>{
      ...
      await fetch("https://shahzod5.onrender.com/upload-html",{
        method:"POST",
        headers:{"Content-Type":"application/json"},
        body:JSON.stringify({html})
      });
      let r=await fetch("https://shahzod5.onrender.com/latest");
      let j=await r.json();
